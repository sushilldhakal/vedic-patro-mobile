...
export const SITEMAP_ROUTES: SitemapRoute[] = [
  ...
  { path: "/aakash-gochar", ne: "३D आकाश गोचर", en: "3D Aakash Gochar", icon: "planet-outline", group: "panchanga" },
  ...
  { path: "/rashifal", ne: "राशिफल", en: "Rashifal", icon: "star-outline", group: "jyotish" },
  { path: "/jyotish/rashifal", ne: "राशिफल (ज्योतिष)", en: "Rashifal (Jyotish)", icon: "star-outline", group: "jyotish" },
